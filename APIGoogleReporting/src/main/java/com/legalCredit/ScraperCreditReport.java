...
public class ScraperCreditReport implements HttpFunction {
	...
	public void service(HttpRequest request, HttpResponse response) throws Exception {
		...
		case "text/plain":
			...
			result = scrapingPDF(request.getReader().readLine(),response);
			break;
	...
	public String scrapingPDF(String textoPDFBase64,HttpResponse response) {

		String result = "";
		
		try {

			byte[] decoded = Base64.getDecoder().decode(textoPDFBase64);
			...
			if (patron[0].equals("PatronEquifax")) {
				...
				result = "No Pertenece a ningún patrón";
		...
		private String scrapearPatronGenerico(String textoMinuscula, String cra) {
			...
			String employeer[] = new String[]{utilidades.getDatoVertical(textoMinuscula,patronEquifax.getTagEmployee())};
			...
			do {
				...
				if (posicionInicialCuenta > 0) {
					...
					String statusUpdated = utilidades.getDatoHorizontal(textoCuenta, elementos[6]);
					String balance = utilidades.getDatoHorizontal(textoCuenta, elementos[7]);
					String balanceUpdated = utilidades.getDatoHorizontal(textoCuenta, elementos[8]);
					...
					String dateOpened = utilidades.getDatoHorizontal(textoCuenta, elementos[3]);
					String accounttypeone = getAccounttypeonePatronGenerico(textoMinuscula, textoCuenta, accountName);
		...
		private String scrapearEquifaxPatronDos(String textoMinuscula,String textoConFormato) throws IOException {
			...
			String dateofreport = utilidades.getDatoHorizontal(textoMinuscula, patronEquifax.getTagAccountReportDate());
			String address[] = getAddressEquifaxPatronDos(textoMinuscula,patronTransunion.getTagAddress());
			String birthyear = utilidades.getDatoHorizontal(textoMinuscula,patronEquifax.getTagBirthReportDate());
			...
			do {
				...
				if (posicionInicialCuenta > 0 && posicionFinalConFormatoCuenta>posicionInicialConFormatoCuenta) {
					...
					String dateOpened = utilidades.getDatoHorizontal(textoCuenta, elementos[2]);
					...
					String dateClosed = utilidades.getDatoHorizontal(textoCuenta, elementos[12]);
					String statusDetail = "";
					...
					if (accountName.equalsIgnoreCase("pennymac loan services llc")) {
						...
						Map<String,List<HistorialPago>> informacionCuentas = new HashMap<String,List<HistorialPago>>();
		...
		private String scrapearExperianPatronUno(String textoMinuscula, PDDocument document) throws IOException {
			...
			String dateofreport = primeraLinea.substring(0,primeraLinea.indexOf(" "));
			String address[] = getAddressExperianPatronUno(textoMinuscula,patronTransunion.getTagAddress());
			...
			do {
				...
				if (posicionInicialCuentaColumnaUno > 0) {
					...
					String dateOpened = utilidades.getDatoVertical(textoCuentaColumnaCuatro,elementos[3]);
					String statusUpdated = utilidades.getDatoVertical(textoCuentaColumnaCuatro,elementos[8]);
			...
			if (posicionInicialInquiriesColumnaUna > 0  && posicionInicialInquiriesColumnaDos> 0) {
				...
				do {
					...
					if (posicionInicialInquiriesColumnaUna > 0 && posicionInicialInquiriesColumnaUna < posicionFinalInquiriesColumnaUna &&
						...
						String contactInformation = accountInquiriesColumnaUno.substring(accountInquiriesColumnaUno.indexOf(accountName)).replace(accountName, "").replaceAll("\r\n", "");
		...
		private String scrapearExperianPatronDos(String textoMinuscula, PDDocument document,boolean poseeCuentas) throws IOException {
			...
			String dateofreport = utilidades.getDatoVertical(textoMinuscula, "report date");
			...
			if (poseeCuentas) {
				...
				do {
					...
					if (posicionInicialCuenta > 0) {
						...
						String dateOpened = utilidades.getDatoVertical(textoCuenta,elementos[3]);
						String accountType = utilidades.getDatoVertical(textoCuenta,elementos[6]);
						String statusUpdated = utilidades.getDatoVertical(textoCuenta,elementos[8]);
		...
		private String scrapearExperianPatronCinco(String textoMinuscula, String textoConFormatoMiniscula,PDDocument document,boolean poseeCuentas) {
			...
			String dateofreport = utilidades.getDatoHorizontal(textoMinuscula, "date generated");
			...
			if (poseeCuentas) {
				...
				do {
					...
					if (posicionInicialCuenta > 0) {
						...
						String paymentStatus = "";
						String statusUpdated =  utilidades.getDatoHorizontal(textoCuenta,elementos[7]);
						String balance =    utilidades.getDatoHorizontal(textoCuenta,elementos[5]);
						String balanceUpdated =  utilidades.getDatoHorizontal(textoCuenta,elementos[12]);
			...
			textosTiposCuentas[0] = textosTiposCuentas[0].replaceAll("( )+", " ");
			textosTiposCuentas[1] = textosTiposCuentas[1].replaceAll("( )+", " ");
		...
		private String scrapearTransunionPatronUno(String textoMinuscula, String textoMinusculaConFormato,PDDocument document, boolean poseeCuentas) throws IOException {
			...
			String dateofreport = utilidades.getDatoHorizontal(textoMinuscula,elementosReporte[1]);
		...
		private String[] getAddressExperianPatronUno(String textoMinuscula,String tag) {
			...
			int posicionInicialAddress = textoMinuscula.indexOf(tag);
			int posicionFinalAddress =  textoMinuscula.indexOf("address");

			if (posicionFinalAddress < 0) 

				posicionFinalAddress =  textoMinuscula.indexOf("year of birth");
		...
		private String getNombreEmpleadorTransunion(PosicionTextoPDF posicionTextoPDF,PDDocument document) throws IOException {
			...
			if (posicionTexto != null) {
				...
				employer = utilidades.getDatoVertical(textoArea.replace("NULL", "").toLowerCase(),patronTransunion.getTagEmployee());
			}
		...
		private String generarJSON(Reporte reporte,List<CuentaReporte> cuentasReporte, 
			...
			jsonReporte.put("bureau ", reporte.getCra());
			jsonReporte.put("employeer", reporte.getEmployeer()!= null ? new JSONArray(Arrays.asList(reporte.getEmployeer())) : "");
			jsonReporte.put("opencreditcards",reporte.getOpencreditcards());
			jsonReporte.put("openretailcards",reporte.getOpenretailcards());
			jsonReporte.put("openrealrstateloans",reporte.getOpenrealrstateloans());
			jsonReporte.put("openinstallmentloans",reporte.getOpeninstallmentloans());
			jsonReporte.put("totalopenaccounts",reporte.getTotalopenaccounts());
			jsonReporte.put("accountseverlate",reporte.getAccountseverlate());
			jsonReporte.put("collectionsaccounts",reporte.getCollectionsaccounts());
			jsonReporte.put("averageaccountage",reporte.getAverageaccountage());
			jsonReporte.put("oldestaccount",reporte.getOldestaccount());
			jsonReporte.put("newestaccount",reporte.getNewestaccount());
			jsonReporte.put("myhardcreditinquiries",reporte.getMyhardcreditinquiries());
			jsonReporte.put("creditdebt",reporte.getCreditdebt());
			jsonReporte.put("totalcredit",reporte.getTotalcredit());
			jsonReporte.put("creditandretailcarddebt",reporte.getCreditandretailcarddebt());
			jsonReporte.put("realestatedebt",reporte.getRealestatedebt());
			jsonReporte.put("installmentloansdebt",reporte.getInstallmentloansdebt());
			jsonReporte.put("collectionsdebt",reporte.getCollectionsdebt());
			jsonReporte.put("totaldebt",reporte.getTotaldebt());
			jsonReporte.put("mypublicrecords",reporte.getMypublicrecords());
			jsonReporte.put("dateofreport",reporte.getDateofreport());
			jsonReporte.put("creditscore",reporte.getCreditscore());
			jsonReporte.put("address",reporte.getAddress()!=null ? new JSONArray(Arrays.asList(reporte.getAddress())) : "");
			jsonReporte.put("birthyear",reporte.getBirthyear());
			jsonReporte.put("overallcreditusage",reporte.getOverallcreditusage());
			jsonReporte.put("patron",reporte.getPatron());
			...
			for (CuentaReporte cuentaReporte : cuentasReporte) {
				...
				jsonCuentaReporte.put("accountName",cuentaReporte.getAccountName());
				jsonCuentaReporte.put("accountNumber",cuentaReporte.getAccountNumber());
				jsonCuentaReporte.put("accountType",cuentaReporte.getAccountType());
				jsonCuentaReporte.put("accountStatus",cuentaReporte.getAccountStatus());
				jsonCuentaReporte.put("paymentStatus",cuentaReporte.getPaymentStatus());
				jsonCuentaReporte.put("statusUpdated",cuentaReporte.getStatusUpdated());
				jsonCuentaReporte.put("balance",cuentaReporte.getBalance());
				jsonCuentaReporte.put("balanceUpdated",cuentaReporte.getBalanceUpdated());
				jsonCuentaReporte.put("limit",cuentaReporte.getLimit());
				jsonCuentaReporte.put("monthlyPayment",cuentaReporte.getMonthlyPayment());
				jsonCuentaReporte.put("pastDueAmount",cuentaReporte.getPastDueAmount());
				jsonCuentaReporte.put("highestBalance",cuentaReporte.getHighestBalance());
				jsonCuentaReporte.put("terms",cuentaReporte.getTerms());
				jsonCuentaReporte.put("responsibility",cuentaReporte.getResponsibility());
				jsonCuentaReporte.put("yourStatement",cuentaReporte.getYourStatement());
				jsonCuentaReporte.put("comments",cuentaReporte.getComments());
				jsonCuentaReporte.put("dateOpened",cuentaReporte.getDateOpened());
				jsonCuentaReporte.put("loanType",cuentaReporte.getLoanType());
				jsonCuentaReporte.put("dateClosed",cuentaReporte.getDateClosed());
				jsonCuentaReporte.put("statusDetail",cuentaReporte.getStatusDetail());
				jsonCuentaReporte.put("paymentReceived",cuentaReporte.getPaymentReceived());
				jsonCuentaReporte.put("originalCreditor",cuentaReporte.getOriginalCreditor());
				jsonCuentaReporte.put("lastActivity",cuentaReporte.getLastActivity());
				jsonCuentaReporte.put("accounttypeone",cuentaReporte.getAccounttypeone());
				jsonCuentaReporte.put("accounttypetwo",cuentaReporte.getAccounttypetwo());
				jsonCuentaReporte.put("creditusage",cuentaReporte.getCreditusage());
				jsonCuentaReporte.put("creditusagedescription",cuentaReporte.getCreditusagedescription());
			...
			jsonReporte.put("accountsCredit",cuentasReporteArray);
			...
			if (cuentaInquieries != null) {
				...
				for (Inquiery inquiery : cuentaInquieries) {
					...
					jsonCuentaInquiries.put("accountName",inquiery.getAccountName()); 
					jsonCuentaInquiries.put("inquiryDate",inquiery.getInquiryDate()); 
					jsonCuentaInquiries.put("removalDate",inquiery.getRemovalDate());
					jsonCuentaInquiries.put("businessType",inquiery.getBusinessType());
					jsonCuentaInquiries.put("contactInformation",inquiery.getContactInformation()); 
					jsonCuentaInquiries.put("inquieresType",inquiery.getInquieresType());
			...
			jsonReporte.put("accountsInquiries",cuentasReporteInquiriesArrays);
			...
			if (publicAccounts != null) {
				...
				for (PublicAccount publicAccount : publicAccounts) {
					...
					publicAccountReporte.put("accountName",publicAccount.getAccountName());
					publicAccountReporte.put("filingDate",publicAccount.getFilingDate());
					...
					publicAccountReporte.put("plaintiff",publicAccount.getPlaintiff());
			...
			jsonReporte.put("accountsPublic",publicAccountsReporteArrays);
